    ...
    switch(type) {
        ...
        case 'deal-service':
            content = `
                ...
                <p>Точка входа на самом важном этапе. Контроль подписания, безопасные расчёты и приёмка-передача.</p>
                <h3>Что входит:</h3>
                <ul>
                    <li>Юридическая проверка объекта, продавца/покупателя;</li>
                    <li>Контроль подписания, корректность реквизитов и расчётов (аккредитив/ячейка);</li>
                    <li>Акт приёма-передачи, фиксация показаний счётчиков;</li>
                    <li>Подача/контроль регистрации в Росреестре.</li>
                </ul>
        ...
        case 'hour-service':
            content = `
                ...
                <h4>Что входит:</h4>
                <ul>
                    <li>Консультация и экспресс-проверка документов/условий;</li>
                    <li>Оценка рисков сделки и рекомендации по действиям;</li>
                    <li>Связь по телефону/месенджерам в течение часа;</li>
                    <li>При необходимости — выезд (по согласованию).</li>
                </ul>
                <p class="price">Стоимость: от 3 000 ₽</p>
                <button class="btn" onclick="openModal('consultation')">Заказать</button>
            `;
        ...
        case 'day-service':
            content = `
                <h2>Агент на день</h2>
                <p>Сопровождение в течение рабочего дня. Идеально для просмотра нескольких объектов и сбора пакета документов.</p>
                <h4>Что входит:</h4>
                <ul>
                    <li>Маршрут по объектам, проверка планировок и перепланировок;</li>
                    <li>Проверка документов сторон, анализ договора (предвари-/ДКП);</li>
                    <li>Переговоры, согласование условий и аванса/задатка;</li>
                    <li>Отчёт по итогам дня и чёткий план дальнейших шагов.</li>
                </ul>
